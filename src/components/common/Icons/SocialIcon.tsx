...
const fillColorMapper = {
  'white-primary': 'fill-white-primary',
  'white-secondary': 'fill-white-secondary',
  'white-tertiary': 'fill-white-tertiary',
  'white-quaternary': 'fill-white-quaternary',
  'black-primary': 'fill-black-primary',
  'black-secondary': 'fill-black-secondary',
  'black-tertiary': 'fill-black-tertiary',
  'black-quaternary': 'fill-black-quaternary'
}
...
const SocialIcon: FC<SocialIconProps> = ({ type, color = 'white-primary' }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className={styles} fill="currentColor" viewBox="0 0 24 24">
      <path d={iconPath} />
    </svg>
  )
}
